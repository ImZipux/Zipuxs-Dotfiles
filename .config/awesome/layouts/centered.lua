...
function mylayout.arrange(p)
    ...
    for idx = 1, nmaster do
        ...
        g = {
            ...
            width = master_area_width - 10,
            height = area.height / nmaster - 10,
        }
        p.geometries[c] = g
    end
    ...
    for idx = 1, nslaves do
        ...
        if idx % 2 == 0 then
            g = {
                ...
                width = slave_width - 10,
                height = area.height / number_of_left_sided_slaves - 10,
            }
            ...
            g = {
                ...
                width = slave_width - 10,
                height = area.height / number_of_right_sided_slaves - 10,
            }
